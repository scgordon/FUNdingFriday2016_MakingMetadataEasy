...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:swe="http://schemas.opengis.net/sweCommon/2.0/" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:gml="http://www.opengis.net/gml/3.2"
  ...
  <xd:doc xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet">
    <xd:desc>
      ...
      <xd:p><xd:b>Version:</xd:b>1.31</xd:p>
      <xd:p><xd:b>Created on:</xd:b>May 5, 2015</xd:p>
      ...
      <xd:p>
        ...
        <xd:p>Reverted namespace changes (keeping eos:EOS_Platform/gmi:instrument) and added OperationsMode to needAcquisitionExtensions (it is an AdditionalAttribute)</xd:p>
      </xd:p>
      <xd:p>
  ...
  <xsl:variable name="needAcquisitionExtensions" select="
  ...
  <xsl:template match="/">
    ...
    <gmi:MI_Metadata xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:gsr="http://www.isotc211.org/2005/gsr" xmlns:gss="http://www.isotc211.org/2005/gss" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:srv="http://www.isotc211.org/2005/srv"
      xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:swe="http://schemas.opengis.net/sweCommon/2.0/" xmlns:eos="http://earthdata.nasa.gov/schema/eos">
      <xsl:comment>
      ...
      <gmd:dateStamp>
        <gco:Date>
          <xsl:choose>
            <xsl:when test="/Collection/RevisionDate | /Granule/DataGranule/ProductionDateTime">
              <xsl:value-of select="/Collection/RevisionDate | /Granule/DataGranule/ProductionDateTime"/>
            </xsl:when>
            <xsl:otherwise>
        ...
        <gmd:MD_DataIdentification>
          ...
          <xsl:for-each select="/*/Collection">
            <gmd:aggregationInfo>
              ...
              <gmd:MD_AggregateInformation>
                ...
                <!-- In granule records these are all LargeWorkCitations / collections (no CollectionType is included) -->
                <gmd:associationType>
                  <xsl:call-template name="writeCodelist">
                    <xsl:with-param name="codeListName" select="'DS_AssociationTypeCode'"/>
          ...
          <gmd:supplementalInformation>
            <xsl:for-each select="/*/CSDTDescriptions/CSDTDescription">
              <xsl:call-template name="writeCharacterString">
                <xsl:with-param name="stringToWrite" select="
                    concat('CSDT', position(), ': ', PrimaryCSDT,
        ...
        <gmd:contentInfo>
          ...
          <gmd:MD_CoverageDescription>
            ...
            <gmd:dimension>
              <gmd:MD_Band>
                <gmd:otherPropertyType>
                  <gco:RecordType xlink:href="http://www.echo.nasa.gov/ingest/schemas/operations/Collection.xsd#xpointer(//element[@name='AdditionalAttributes'])">Echo Additional Attributes</gco:RecordType>
                </gmd:otherPropertyType>
                <gmd:otherProperty>
                  <gco:Record xmlns:eos="http://www.echo.nasa.gov/ingest/schemas/operations">
                    <eos:AdditionalAttributes>
                      <xsl:for-each select="//AdditionalAttribute">
                        <xsl:choose>
      ...
      <xsl:if test="/*/ProcessingLevelId or /*/CloudCover">
        ...
        <gmd:contentInfo>
          <xsl:comment select="'Image Description Information'"/>
